...
# Testing a random env with open AI gym. Another env = ALE/SpaceInvaders-v5
env = gym.make("SpaceInvaders-v0", render_mode="rgb_array") # use render_mode="human" to visualize the gameplay
